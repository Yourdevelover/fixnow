...
<style>
    ...
    .stat-card:hover {
        ...
        box-shadow: 0 8px 20px rgba(35, 90, 157, 0.12);
    }
    ...
    .stat-card.users .stat-icon       { background: var(--light); color: var(--navy); }
    .stat-card.technicians .stat-icon { background: #ecfdf5; color: #16a34a; }
    .stat-card.services .stat-icon    { background: #fff7ed; color: #f59e0b; }
    .stat-card.orders .stat-icon      { background: #f5f3ff; color: #7c3aed; }
    ...
    .stat-card.users::after       { background: var(--navy); }
    .stat-card.technicians::after { background: #16a34a; }
    .stat-card.services::after    { background: #f59e0b; }
